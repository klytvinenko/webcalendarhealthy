            ...
            <ul id="diets_list">
                ...
                foreach ($diets as $diet) {
                    ...
                    <li id="diet_<?=$diet['id']?>">
                        <div class="row w-50">
                            <p><?= $diet['name'] ?></p>
                            <i class="text-light"><?= $diet['description'] ?></i>
                        </div>
                        <div class="icons">
                            <button class="button-icon button-icon-add" onclick="href('/admin/diet/diets/add_list?id=<?=$diet['id']?>')">
            ...
            <ul id="allergies_list">
                ...
                foreach ($allergies as $allergy) {
                    ...
                    <li id="allergy_<?=$allergy['id']?>">
                        ...
                        <div class="icons">
                        <button class="button-icon button-icon-add" onclick="href('/admin/diet/allergies/add_list?id=<?=$allergy['id']?>')">
                                <ion-icon name="list-outline" title="Додати список продукти/рецепти"></ion-icon>
                            </button>
