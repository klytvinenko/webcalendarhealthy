        ...
        <tbody>
            ...
            foreach ($products as $product) {
                ...
                <tr id="product_<?=$product['id']?>">
                    ...
                    <td class="icons">
                    <button class="button-icon button-icon-show" onclick="href('/admin/products/edit?id=<?=$product['id']?>')" title="Переглянути"><ion-icon
                                    name="ellipsis-horizontal-circle-outline"></ion-icon></button>
                        <button class="button-icon button-icon-edit" onclick="href('/admin/products/edit?id=<?=$product['id']?>')" title="Редагувати"><ion-icon
                                    name="create-outline"></ion-icon></button>
                            <button class="button-icon button-icon-remove" onclick="Delete('/admin/products/delete?id=<?=$product['id']?>','product_<?=$product['id']?>')"><ion-icon name="close-circle-outline"
